			...
			<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
						 ...
						 <div class="form-group">
							...
							<select name="access" class="form-control">
								 ...
								 <?php foreach($groups as $group) : ?>
								 	<?php if($article->access == 1) : ?>
								 		<?php $selected1 = 'selected'; ?>
								 	<?php else : ?>
								 		<?php $selected1 = ''; ?>
								 	<?php endif; ?>
								 	<option value="<?php echo $group->id; ?>" <?php echo $selected1; ?>><?php echo $group->name; ?></option>
								 <?php endforeach; ?>            
							</select>
						</div>		
						<div class="form-group">
							...
							<select name="user" class="form-control">
								 ...
								 <?php foreach($users as $user) : ?>
								 	...
								 	<?php else : ?>
								 		<?php $selected2 = ''; ?>
								 	<?php endif; ?>
								 	<option value="<?php echo $user->id; ?>" <?php echo $selected2; ?>><?php echo $user->first_name; ?> <?php echo $user->last_name; ?></option>
								 <?php endforeach; ?>       
							</select>
						</div>		
						<div class="form-group">
						...
						<div class="form-group">
							<label>Order</label>
							<input class="form-control" style="width:40px" type="text" name="order" value="<?php echo $article->ordered; ?>" />
						</div>
						</div>
				</div><!-- /.row -->
			</form>
